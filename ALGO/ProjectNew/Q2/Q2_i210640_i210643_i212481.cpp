...
bool readTestCase(const string &filename, vector<string> &text, string &pattern, int &minOccurrences)
{
    ...
    {
        cout << "Error reading dimensions from the file." << endl;
        return false;
    }
    ...
    for (int i = 0; i < n; i++)
    {
        ...
        {
            cout << "Error reading text from the file." << endl;
            return false;
        }
    }
    ...
    {
        cout << "Error reading pattern and/or minimum occurrences from the file." << endl;
        return false;
    }
